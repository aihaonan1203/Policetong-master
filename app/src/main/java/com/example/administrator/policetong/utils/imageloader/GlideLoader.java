...
public class GlideLoader implements ILoader {
    ...
    @Override
    public void loadCircleWithBorder(String url, ImageView target, Options options, int width, int color) {
        RequestOptions requestOptions = wrapScaleType(options);
        requestOptions.centerCrop()
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .transform(new GlideCircleBorderTransform(width, color));
    ...
    @SuppressLint("CheckResult")
    @Override
    public void loadCircleWithBorder(Bitmap photo, ImageView target, Options options, int width, int color) {
        RequestOptions requestOptions = wrapScaleType(options);
        requestOptions.centerCrop()
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .transform(new GlideCircleBorderTransform(width, color));
    ...
    @Override
    public void loadCircleWithBorder(int photo, ImageView target, Options options, int width, int color) {
        RequestOptions requestOptions = wrapScaleType(options);
        requestOptions.centerCrop()
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .transform(new GlideCircleBorderTransform(width, color));
    ...
    @Override
    public void loadCorner(Bitmap bitmap, final RelativeLayout target, int radius, Options options) {
        RequestOptions requestOptions = wrapScaleType(options);
    ...
    @Override
    public void loadCorner(String url, final RelativeLayout target, int radius, Options options) {
        RequestOptions requestOptions = wrapScaleType(options);
