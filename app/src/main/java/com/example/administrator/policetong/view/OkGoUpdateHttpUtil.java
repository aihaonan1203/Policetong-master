...
public class OkGoUpdateHttpUtil implements HttpManager {
    ...
    public void asyncGet(@NonNull String url, @NonNull Map<String, String> params, @NonNull final Callback callBack) {
        OkGo.<String>get(url).headers("token",App.userInfo.getToken()).headers("user",App.userInfo.getUser().getUser()).headers("time","").params(params).execute(new com.lzy.okgo.callback.StringCallback() {
            @Override
